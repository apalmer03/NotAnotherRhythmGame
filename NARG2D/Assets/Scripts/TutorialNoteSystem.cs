...
public class TutorialNoteSystem : MonoBehaviour
{
    ...
    public TutorialUltimateNote ultUp,
        ultDown,
        ultLeft,
        ultRight,
        ultUpDown,
    ...
    public static TutorialNoteSystem instance;
    ...
    private TutorialUltimateNote ultNote;
    ...
    private void SpawnUltNote()
    {
        ...
        ultNote.GetComponent<TutorialUltimateNote>().SetNote(instance);
